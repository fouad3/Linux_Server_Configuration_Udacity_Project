...
1. Create new user named grader and give sudo permission
...
3. Configure firewall for SSH (port 2200), HTTP (port 80), and NTP (port 123)
...
7. configure key in server mahcine:
...
8. Install Apache, mod_wsgi and clone the Catalog app
...
9. Install virtual environment,Flask and PostgreSQL :
